...
IDX = {
    ...
    ### Eyebrows - along the top edge, 1-5 left-right
    # Left eyebrow (subject's left)
    "EYEBROW_L_1": 300, "EYEBROW_L_2": 293, "EYEBROW_L_3": 334, "EYEBROW_L_4": 296, "EYEBROW_L_5": 336,
    # Right eyebrow (subject's right)
    "EYEBROW_R_1": 107, "EYEBROW_R_2": 66, "EYEBROW_R_3": 105, "EYEBROW_R_4": 63, "EYEBROW_R_5": 70,
}
...
def eyebrow_metrics(face_landmarks, w, h):
    """Return distance between eyebrow landmarks closest to nose, normalised by inter-ocular width."""
    left_inner = lmk_xy(face_landmarks, IDX["EYEBROW_L_5"], w, h)
    right_inner = lmk_xy(face_landmarks, IDX["EYEBROW_R_1"], w, h)
    eyebrow_dist = euclid(left_inner, right_inner)
    ...
    return eyebrow_dist / eye_outer_width
