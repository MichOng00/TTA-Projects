...
class Fly(Obstacle): # subclass of Obstacle class
    def __init__(self, image):
        super().__init__(image, 0) # copy init method of superclass
...
def main():
    ...
    global dinosaurs, obstacles, game_speed, points, x_pos_bg, y_pos_bg
    x_pos_bg = 0
    y_pos_bg = 380
    points = 0
    ...
    while run:
        while game_over:
            ...
            text = FONT.render(f"Game over! You scored {points} points. Press 'R' to restart or 'Q' to quit.", True, (255, 0, 0))
        ...
        if len(obstacles) == 0: # no more obstacles
            ...
            if choice == 0: # randomly pick between small and large cactus
