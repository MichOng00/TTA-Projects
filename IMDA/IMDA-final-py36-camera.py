...
Trying to reimplement the original code with camera (incomplete).
"""
...
def seek_qrcode():
    ...
    while True:
        ...
        if tags[1] != -1: # UGOT sets all entries except first to -1 if no tags are detected
            ...
            _, _, cx, cy, h, w, _, distance, *_ = tags #TODO: check
...
def main():
    ...
    if got.VISION.camera_client_id > 0:
        pass
    else:
        got.VISION.camera_client_id = got.VISION.openCamera()
    time.sleep(1)
